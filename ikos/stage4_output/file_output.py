...
class FileOutputter:
    ...
    def export_knowledge_graph(
        self, knowledge_graph: dict[str, Any], output_dir: str, format: str = "json"
    ) -> dict[str, Any]:
        """导出知识图谱。
    ...
    def export_structured_data(
        self, structured_data: dict[str, Any], output_dir: str, format: str = "json"
    ) -> dict[str, Any]:
        """导出结构化数据。
    ...
    def export_document(
        self, content: str, output_dir: str, format: str = "markdown", filename: str | None = None
    ) -> dict[str, Any]:
        """导出文档。
