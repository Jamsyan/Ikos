...
class TaskSplitter:
    ...
    def split(self, engineered_prompt: str, core_topic: str) -> dict[str, Any]:
        """执行任务拆分。
    ...
    def review(self, task_list: dict[str, Any], core_topic: str) -> dict[str, Any]:
        """审核拆分后的任务列表。
