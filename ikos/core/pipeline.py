...
class IkosPipeline:
    ...
    def __init__(self, config_path: str = "config/settings.yaml"):
        ...
        self.model_provider = OllamaProvider(
            base_url=self.config.get("model", {}).get("ollama", {}).get("base_url", "http://localhost:11434"),
    ...
    def _run_stage2(self, stage1_result: dict[str, Any]) -> dict[str, Any]:
        ...
        if tasks.get("tasks"):
            ...
            search_result = self.stage2_searcher.execute_task(first_task, core_topic)
    ...
    def _run_stage3(
        ...
        rewritten_content = self.stage3_refiner.rewrite(
            refined,
            knowledge_graph,
            core_topic
        )
