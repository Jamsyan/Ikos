...
class SideSupervisor:
    ...
    def monitor(self, parse_history: list[dict[str, Any]], core_topic: str) -> dict[str, Any]:
        """监控解析方向。
    ...
    def _calculate_deviation(self, parse_history: list[dict[str, Any]], core_topic: str) -> float:
        """计算偏离指数。
