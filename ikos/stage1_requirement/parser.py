...
class RequirementParser:
    ...
    def __init__(self, model_provider: ModelProvider, config_path: str | None = None):
        ...
        if config_path is None:
            config_path = (
                Path(__file__).parent.parent.parent / "config" / "prompts" / "stage1_parse.yaml"
            )
    ...
    def parse(self, user_input: str) -> dict[str, Any]:
        ...
        # 使用初始解析提示词
        prompt = format_prompt(self.prompts["initial_parse"], user_input=user_input)
    ...
    def generate_final_prompt(self, core_topic: str, core_circle: dict[str, Any]) -> dict[str, Any]:
        """生成最终的工程化提示词。
    ...
    def _parse_json_response(self, content: str) -> dict[str, Any]:
        ...
        try:
            ...
            logger.warning("JSON 解析失败，使用备用解析")
            return {}
