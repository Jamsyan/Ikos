...
class KnowledgeGraphBuilder:
    ...
    def build_from_data(self, data: list[dict[str, Any]], core_topic: str) -> dict[str, Any]:
        """从数据构建知识图谱。
        ...
        for i, item in enumerate(data):
            ...
            if title:
                ...
                # 添加到核心节点的边
                self.add_edge(source="core", target=node_id, relation="related_to")

                # 如果有前一个节点，添加顺序关系
                if prev_node_id and prev_node_id != "core":
                    self.add_edge(source=prev_node_id, target=node_id, relation="sequence")
